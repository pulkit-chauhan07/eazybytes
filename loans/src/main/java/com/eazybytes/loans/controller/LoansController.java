...
public class LoansController {
    ...
    @Operation(
            ...
            description = "REST API to create a loan in Eazybank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    @Operation(
            ...
            description = "REST API to fetch loan details based on provided mobile number."
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "REST API to update a loan record using loan number"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
